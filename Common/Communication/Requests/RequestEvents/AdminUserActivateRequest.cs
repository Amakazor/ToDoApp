...
{
    [DataContract()]
    internal class AdminUserActivateRequest : AdminUserRequest
    {
        public AdminUserActivateRequest(string username, string password, User modifiedUser) : base(username, password, modifiedUser)
        {
        }
